...
// In recent chrome versions, the webview doesn't show up in the usual UiDevice.dumpWindowHierarchy()
// This is modification of AccessibilityNodeInfoDumper(existing class). It is patched to provide dump of all visible/non-visible views
